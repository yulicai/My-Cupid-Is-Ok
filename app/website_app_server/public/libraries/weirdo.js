...
class Weirdo {
    constructor(x, y, weight, breathTime) {
        ...
        this.currentImgIndex = floor(random(6));
    }
    ...
    display() {
        ...
        image(arrow, this.x, this.y-10, this.weight*1.5, this.weight*1.5);
        image(statues[this.currentImgIndex], mouth_pos.x, mouth_pos.y, this.mouthSize.x, this.mouthSize.y);
