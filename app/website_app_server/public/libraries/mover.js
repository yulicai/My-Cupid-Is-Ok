class Boid {
    constructor(m, x, y) {
        ...
        this.maxforce = 0.03; //最大作用的力

        this.weirdo = new Weirdo(this.pos.x, this.pos.y,random(30,60),random(160,280));
    }

    // run(boids) {
    //     this.flock(boids); //这个单独的boid会跟其他的boids进行互动
    //     this.update();
    //     this.checkEdges();
    //     this.display();
    // }
